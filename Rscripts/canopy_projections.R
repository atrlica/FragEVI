...
resim.vers <- 9 ## what are we labeling this round of resims?
...
realize <- 100 ## how many realizations to put every pixel resim through (model+simulator error)
...
#   length(npp.contain) ## should be = realizations
