...
try:
    can0Filt = arcpy.Raster("E:/FragEVI/processed/bos_can0_filt.tif")
    ...
    arcpy.Select_analysis(in_features = "bos_can_P", out_feature_class = "bos_can_0", where_clause = "gridcode = 0")
    ...
    arcpy.PolygonToRaster_conversion(in_features="bos_can_0_filt", value_field="gridcode", out_rasterdataset="bos_can_0_R", cell_assignment="CELL_CENTER", priority_field="gridcode", cellsize="1")
    arcpy.CopyRaster_management(in_raster = "bos_can_0_R", out_rasterdataset = "E:/FragEVI/processed/bos_can0_filt.tif", format = "TIFF")
