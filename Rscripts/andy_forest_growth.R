...
test <- seq(from=andy.xlim[1], to = andy.xlim[2], length.out=100)
...
g[seg!=10, seg.F:="I"]
g$seg.F <- as.factor(g$seg.F)
g[,biom.Mg.ha:=((biom/1000)/(10*20))*1E4] ## get things in a standard biomass density Mg.ha based on plot size
